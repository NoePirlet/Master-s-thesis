# -*- coding: utf-8 -*-
"""
Created on Fri Oct 29 15:48:00 2021
...
annual_mean_mslp = annual_mean(sum_year(mslp))
...
def plot_map(lon,lat, lb, ub, step, units ,args, name, which, arrow, my_color):
    ...
    if which == "double":
        ...
        center = (lb+ub)/2
        norm = colors.DivergingNorm(vmin=lb, vcenter= center , vmax=ub)#!!!
...
plot_map(lon,lat, 980, 1020, 2 ,'$\mathregular{hP}$', annual_mean_mslp/100, "mslp", "double", "both" , "coolwarm")    
